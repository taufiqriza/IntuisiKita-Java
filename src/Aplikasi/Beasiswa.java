 ...
 * @author TIUNIDA 28
 */
public class Beasiswa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Materi1 = new javax.swing.JTextField();
        ...
        getContentPane().add(Nama, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 110, 180, 30));

        ID.setBorder(null);
        ID.setOpaque(false);
        getContentPane().add(ID, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 160, 180, 30));

        Kelas.setBorder(null);
        Kelas.setOpaque(false);
        getContentPane().add(Kelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 210, 180, 30));

        Durasi.setBorder(null);
        Durasi.setOpaque(false);
        getContentPane().add(Durasi, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 280, 180, 30));

        Materi.setBorder(null);
        Materi.setOpaque(false);
        getContentPane().add(Materi, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 330, 180, 30));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 110, 300, 340));
        getContentPane().add(Cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 400, 90, 30));
        ...
        getContentPane().add(Dashboard, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 120, 30));
        ...
        getContentPane().add(Back, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 120, 30));
        ...
        getContentPane().add(Nama1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 110, 180, 30));

        ID1.setBorder(null);
        ID1.setOpaque(false);
        getContentPane().add(ID1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 160, 180, 30));

        Kelas1.setBorder(null);
        Kelas1.setOpaque(false);
        getContentPane().add(Kelas1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 210, 180, 30));

        menu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Aplikasi/img/Beasiswa.png"))); // NOI18N
        getContentPane().add(menu1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 900, 550));

        Durasi1.setBorder(null);
        Durasi1.setOpaque(false);
        getContentPane().add(Durasi1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 280, 180, 30));

        Materi1.setBorder(null);
        Materi1.setOpaque(false);
        getContentPane().add(Materi1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 330, 180, 30));
        getContentPane().add(Cari1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 400, 90, 30));
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 110, 300, 340));

        menu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Aplikasi/img/Beasiswa.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Beasiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField Materi1;
