...
public class Bimbingan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 120, 30));
        ...
        ID.setBorder(null);
        ID.setOpaque(false);
        getContentPane().add(ID, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 170, 180, 20));

        Pembimbing.setBorder(null);
        Pembimbing.setOpaque(false);
        getContentPane().add(Pembimbing, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 250, 180, 20));

        Nama.setBorder(null);
        Nama.setOpaque(false);
        getContentPane().add(Nama, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 130, 180, 20));

        Keluhan.setBorder(null);
        Keluhan.setOpaque(false);
        getContentPane().add(Keluhan, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 210, 180, 20));
        getContentPane().add(Cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 300, 200, 30));
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 110, 240, 240));

        menu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Aplikasi/img/Bimbingan.png"))); // NOI18N
