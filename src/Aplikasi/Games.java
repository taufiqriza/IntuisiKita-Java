...
public class Games extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Snake.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                SnakeMouseClicked(evt);
            }
        });
        getContentPane().add(Snake, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 380, 150, 110));

        txtAD.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                txtADMouseClicked(evt);
            }
        });
        getContentPane().add(txtAD, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 380, 140, 110));

        Menu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Aplikasi/img/Game.png"))); // NOI18N
...
//        }
    ...
    private void SnakeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SnakeMouseClicked
        RunUlar ular = new RunUlar();
        ular.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_SnakeMouseClicked

    private void txtADMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtADMouseClicked
        txtAdventure txtAd = new txtAdventure();
        txtAd.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_txtADMouseClicked
