 ...
 * @author TIUNIDA 28
 */
public class Inggris extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inggris.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
